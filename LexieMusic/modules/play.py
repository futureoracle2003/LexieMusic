...
async def play(_, message: Message):
            ...
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        ...
                        "\n\nor manually add [assistant](https://t.me/LexieMusic) to your Group and try again</b>",
                    )
    try:
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/7143571d0eb5a31e8213d.jpg"
...
async def ytplay(_, message: Message):
    ...
    if chat_id in callsmusic.active_chats:
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="▶️ <b>Playing</b> here the song requested by {} via Lexie Music 😎".format(message.from_user.mention()),
        )
        os.remove("final.png")
        return await lel.delete()
...
async def deezer(client: Client, message_: Message):
    ...
    try:
        ...
        thumbnail = "https://telegra.ph/file/7143571d0eb5a31e8213d.jpg"
